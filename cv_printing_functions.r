...
create_CV_object <-  function(data_location,
  ...
  cv$skills       <- readr::read_csv(paste0(data_location, "skill_data.csv"), skip = 1)
...
print_skill_bars <- function(skills_sec, out_of = 5, bar_color = "#969696", bar_background = "#d9d9d9", glue_template = "default"){
